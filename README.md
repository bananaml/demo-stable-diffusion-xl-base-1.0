...
# Banana.dev stable-diffusion-xl-base-1.0 starter template

This is a stable-diffusion-xl-base-1.0 starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/bananaml/demo-stable-diffusion-xl-base-1.0/fork) repository to your own Github account.
